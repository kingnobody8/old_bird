...
namespace Engine
{
	namespace Part
	{
		...
		public:
			...
			//Gets
			inline Object::CObject*		GetOwner(void) const { return this->m_pOwner; }
			inline const Util::ulong&	GetPriority(void) const { return this->m_priority; }
			...
			//Sets
			virtual inline void			SetOwner(Object::CObject* const pOwner) { this->m_pOwner = pOwner; }
...
#define DEFINE_PART_TYPE_INFO(CLASS)																\
			const int CLASS::Type = Part::IPart::RegisterPart(#CLASS, Util::CNewType<CLASS>());		\
